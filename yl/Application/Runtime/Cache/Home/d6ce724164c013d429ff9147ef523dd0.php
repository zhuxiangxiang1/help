...
.bggray {
	...
	<body>
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
			<tr>
				<td width="99%" align="left" valign="top">您的位置：游戏列表</td>
			</tr>
			<tr>
				...
				<td align="left" valign="top">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
						<tr>
							...
							<th align="center" valign="middle" class="borderright">游戏平台名称</th>
						...
						<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
							...
							<td align="center" valign="middle" class="borderright borderbottom"><a href="<?php echo U('Game/detail');?>?id=<?php echo ($v["id"]); ?>"><?php echo ($v["platform_name"]); ?></a></td>
							<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["platform_remark"]); ?></td>
							<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["create_time"]); ?></td>
							<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["platform_realname"]); ?></td>
							<td align="center" valign="middle" class="borderright borderbottom">
								<a href="<?php echo U('Game/addGame');?>?id=<?php echo ($v["id"]); ?>&name=<?php echo ($v["platform_name"]); ?>">添加游戏</a> |
								<a href="<?php echo U('Platform/Platform_edit');?>?id=<?php echo ($v["id"]); ?>">编辑</a> |
								<a href="<?php echo U('Platform/delPlatform');?>?id=<?php echo ($v["id"]); ?>">删除平台</a>
							</td>
