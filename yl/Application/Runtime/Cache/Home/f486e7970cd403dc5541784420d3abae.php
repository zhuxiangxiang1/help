...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
	<tr>
		<td width="99%" align="left" valign="top">您的位置：后台菜单 > 菜单列表</td>
	</tr>
	<tr>
		...
		<td align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
				<tr>
					...
					<th align="center" valign="middle" class="borderright">父级菜单</th>
					<th align="center" valign="middle" class="borderright">名称</th>
					<th align="center" valign="middle" class="borderright">控制器</th>
					<th align="center" valign="middle" class="borderright">动作</th>
				...
				<?php if(is_array($res)): $k = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
						...
						<?php if($v['names'] == '顶级菜单'): ?><td align="center" valign="middle" class="borderright borderbottom">/</td>
						<?php else: ?>
						<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["names"]); ?></td><?php endif; ?>
						<?php if($v['menu_lev'] == 1): ?><td align="center" valign="middle" class="borderright borderbottom" style='color:red'><?php echo ($v["name"]); ?></td>
						<?php else: ?>
						<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["name"]); ?></td><?php endif; ?>
						<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["menu_c"]); ?></td>
						<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["menu_a"]); ?></td>
						
						<td align="center" valign="middle" class="borderbottom">
							
								<a href="<?php echo U('Menu/edit');?>?id=<?php echo ($v["id"]); ?>" target="mainFrame" onFocus="this.blur()" class="add">编辑</a>
								<span class="gray">&nbsp;|&nbsp;</span>
								<a href="<?php echo U('Menu/delete');?>?id=<?php echo ($v["id"]); ?>" target="mainFrame" onFocus="this.blur()" class="add" onclick="return conf()">删除</a>
