...
.main-for input.text-but {
	...
	<body>
		<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
			<tr>
				<td width="99%" align="left" valign="top">您的位置：Excel管理&nbsp;&nbsp;>&nbsp;&nbsp;此页面是用来测试上传表格用的</td>
			</tr>
			<tr>
				<td align="left" valign="top">
					<form method="post" action="<?php echo U('Excel/testAction');?>" enctype="multipart/form-data" style="margin-top: 20px;">
