...
.bggray {
	...
	<body>
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
			<tr>
				<td width="99%" align="left" valign="top">您的位置：游戏列表 > 游戏折扣详情</td>
			</tr>
			<tr>
				...
				<td align="left" valign="top">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
						<tr>
							...
							<th align="center" valign="middle" class="borderright">所属平台</th>
							<th align="center" valign="middle" class="borderright">游戏折扣</th>
							<th align="center" valign="middle" class="borderright">备注</th>
							<th align="center" valign="middle" class="borderright">添加时间</th>
							<th align="center" valign="middle" class="borderright">平台添加者姓名</th>
						...
						<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
							...
							<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["game_name"]); ?></td>
							<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["platform_name"]); ?></td>
							<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["game_discount"]); ?>折</td>
							<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["game_remark"]); ?></td>
							<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["game_time"]); ?></td>
							<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["game_realname"]); ?></td>
							<td align="center" valign="middle" class="borderbottom">
								<a href="<?php echo U('Game/edit');?>?id=<?php echo ($v["game_id"]); ?>"  target="mainFrame"onFocus="this.blur()" class="add">修改游戏折扣</a>
								<span class="gray">&nbsp;|&nbsp;</span>
								<a href="<?php echo U('Game/del');?>?id=<?php echo ($v["game_id"]); ?>" target="mainFrame" onFocus="this.blur()" class="add">删除游戏</a>
							</td>
