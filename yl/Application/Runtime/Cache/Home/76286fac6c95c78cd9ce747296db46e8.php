...
.bggray {
	...
	<body>
		...
		<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
			<tr>
				<td width="99%" align="left" valign="top">您的位置：上传表格&nbsp;&nbsp;>&nbsp;&nbsp;查看点位表</td>
			</tr>
			<tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
						<tr>
							<td width="90%" align="left" valign="middle">
								<form action="">
									<span>搜索表名：</span>
									<input type="text" name="old_name" value="<?php echo ($_GET['excels_salesman']); ?>" class="text-word">
				...
				<td align="left" valign="top">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
						<tr>
							...
							<th align="center" valign="middle" class="borderright">文件名</th>
							<th align="center" valign="middle" class="borderright">发送者姓名</th>
						...
						<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
							...
							<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["old_name"]); ?></td>
							...
							<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["remark"]); ?></td>
							<td align="center" valign="middle" class="borderbottom">
								<a href="<?php echo ($v["path"]); ?>"  target="mainFrame"onFocus="this.blur()" class="add">下载</a>
								<span class="gray">&nbsp;|&nbsp;</span>
								<a href="<?php echo U('ExcelPoint/delPoint');?>?id=<?php echo ($v["id"]); ?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a>
							</td>
							</td>
