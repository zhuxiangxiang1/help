			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="search">
				<tr>
					<td width="90%" align="left" valign="middle">
						<form action="">
							<span>用户名：</span>
							<input type="text" name="user_phone" value="<?php echo ($_GET['user_phone']); ?>" class="text-word">
		...
		<td align="left" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
				<tr>
					...
					<th align="center" valign="middle" class="borderright">用户身份证号码</th>
					<th align="center" valign="middle" class="borderright">用户邮箱</th>
				...
				<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?><tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
						...
						<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["user_idcard"]); ?></td>
						<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["user_email"]); ?></td>
						<td align="center" valign="middle" class="borderright borderbottom"><?php echo ($v["role_name"]); ?></td>
						<td align="center" valign="middle" class="borderbottom">
							<?php if($v["role_id"] == 1): ?>编辑
								<span class="gray">&nbsp;|&nbsp;</span>
								删除
							<?php else: ?>
								<a href="<?php echo U('User/editMember');?>?id=<?php echo ($v["user_id"]); ?>"  target="mainFrame"onFocus="this.blur()" class="add">编辑</a>
								<span class="gray">&nbsp;|&nbsp;</span>
								<a  onclick="return conf()" href="<?php echo U('User/delUser');?>?id=<?php echo ($v["user_id"]); ?>" target="mainFrame" onFocus="this.blur()" class="add">删除</a><?php endif; ?>	
						</td>
