...
.main-for input.text-but {
	...
	<body>
		<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
			<tr>
				<td height="20px" width="99%" align="left" valign="top">您的位置：游戏列表&nbsp;&nbsp;>&nbsp;&nbsp;发布游戏平台</td>
			</tr>
			<tr>
				<td align="left" valign="top">
					<form method="post" action="<?php echo U('Platform/add');?>">
						<table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
							...
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								<td align="right" valign="middle" class="borderright borderbottom bggray">平台名字：</td>
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<input type="text" name="platform_name" class="text-word" value="">
								</td>
							</tr>
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
								<td align="right" valign="middle" class="borderright borderbottom bggray">备注：</td>
								<td align="left" valign="middle" class="borderright borderbottom main-for">
									<input type="text" name="platform_remark" class="text-word" value="<?php echo ($list["notice_remark"]); ?>">
								</td>
							</tr>
							<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
